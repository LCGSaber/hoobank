    ...
    <div className="main-container">
      ...
      <div className="max-w-5xl mx-auto bg-white/90 backdrop-blur-sm rounded-2xl shadow-xl p-4 md:p-8 border border-gray-100 transition-all duration-500 hover:shadow-2xl">
        ...
        <div className="space-y-8">
          ...
          <div className="bg-gradient-to-r from-primary/5 to-accent/5 rounded-xl p-6 border border-gray-100">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-[clamp(1.75rem,3vw,2.5rem)] font-bold text-neutral mb-4">关于我们</h2>
            <div className="w-20 h-1 bg-primary mx-auto mb-6"></div>
            <p className="text-gray-600 max-w-3xl mx-auto">正心教育是一间专注于提供香港本土及国际化教育的咨询机构</p>
          </div>
              ...
              <div className="bg-neutral-light p-6 rounded-lg hover:shadow-lg hover:-translate-y-1 transition-all duration-300">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">正心教育成立于2016年9月，由一群教育行业资深人士创立，致力于为学生提供专业的教育咨询服务。</p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-neutral-light p-6 rounded-lg hover:shadow-lg hover:-translate-y-1 transition-all duration-300">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">我们试图提供的是一种基于互信的双向的学习和成长关系，以及全方位的跨越区域限制的教育咨询服务。</p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-neutral-light p-6 rounded-lg hover:shadow-lg hover:-translate-y-1 transition-all duration-300">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">正心教育拥有一支专业性高、责任心强的教师团队，咨询师会全程跟踪学生的学业及心理状况。</p>
                  </div>
                </div>
              </div>
            </div>
